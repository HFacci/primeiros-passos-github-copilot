...
activities = {
   ...
   "Artes Visuais": {
      "description": "Pintura, desenho e outras artes visuais",
   ...
   "Clube de Leitura": {
      ...
      "max_participants": 16,
      "participants": ["renata@mergington.edu", "carlos@mergington.edu"]
   },
   "Olimpíada de Matemática": {
      "description": "Preparação para olimpíadas de matemática e resolução de desafios",
      "schedule": "Quintas, 14h - 15h30",
      "max_participants": 25,
      "participants": ["fernando@mergington.edu", "aline@mergington.edu"]
   }
}
